                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="paymentTerms" value="{{ $salesOrder->Terms }}" id="paymentTerms">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="projectStart" data-target-input="nearest" data-date-format='YYYY-MM-DD'>
                                                                <input type="text" class="form-control datetimepicker-input" name="projectStart" value="{{ $setupProject->project_effectivity }}"  data-target="#projectStart"/>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="projectEnd" data-target-input="nearest" data-date-format='YYYY-MM-DD'>
                                                                <input type="text" class="form-control datetimepicker-input" name="projectEnd" value="{{ $salesOrder->DateAndTimeNeeded }}"  data-target="#projectEnd"/>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"  class="form-control" value="{{ $salesOrder->warranty }}" name="warranty" placeholder="">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input data-type="currency" min="0" style="text-align: right" type="text" class="form-control" name="projectCost" value="{{ $salesOrder->amount }}"  placeholder="">
                                                    ...
                                                    <div class="card-body" style="max-height: 300px; overflow: auto; display:inline-block;" >
                                                        <table class="table table-hover text-nowrap" id="systemsTable">
                                                            ...
                                                            <tbody>    
                                                                ...
                                                                {{-- @foreach ( $salesOrderSystem as $systemNamed )                                                              
                                                                    @foreach ($systemName as $system )
                                                                        @if ($systemNamed->sysID == $system->id )
                                                                        <tr>
                                                                            <td><input type="checkbox" name="systemname[]" value="{{ $system->id }}" checked> </td>
                                                    ...
                                                    <div class="card-body" style="max-height: 300px; overflow: auto; display:inline-block;">
                                                        <table class="table table-hover text-nowrap" id="documentTable">
                                                            ...
                                                            <tbody> 
                                                                ...
                                                                @if ($systemDocs->DocID == $docs->ID)
                                                                <tr>
                                                                    <td><input type="checkbox" name="documentname[]" value="{{ $docs->ID }}" checked > </td>
