    ...
    <div class="row">
        ...
        <div class="modal fade"  id="approvedModal" tabindex="-1" role="dialog" aria-labelledby="approvedModal" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('npu.approved.re') }}" method="POST">
                    @csrf
        ...
        <div class="modal fade"  id="rejectedModal" tabindex="-1" role="dialog" aria-labelledby="rejectedModal" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header bg-dark" >
                <h5 class="modal-title" id="rejectedModalLabel">Approve Request</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
                <form action="{{ route('npu.rejected.re') }}" method="POST">
                    @csrf
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
        ...
        <div class="modal fade"  id="clarifyModal" tabindex="-1" role="dialog" aria-labelledby="clarifyModal" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('app.clarify.re') }}" method="POST">
                    @csrf
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" data-target-input="nearest">
                                        <input type="text" id="dateNeeded" name="dateNeeded" class="form-control datetimepicker-input" value="{{ $post->CLIENT_NAME }}" readonly/>
                                        <div class="input-group-append" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
