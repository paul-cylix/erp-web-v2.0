    ...
    <div class="row">
        <div class="col-md-12" style="margin: -20px 0 20px 0 " >
            <div class="form-group" style="margin: 0 -5px 0 -5px;">
                    ...
                    {{-- Checking in approval if last appprove is initiator --}}
                    <?php
                    if (intval($initCheck[0]->initQue) !== 0 ) {
                    ?>
                            ...
                            <div class="col-md-12">                     
                                ...
                                <div class="card-body">
                                    <div class="form-floating">
                                        <input type="hidden" name="apprCheckinit" value="{{ $apprCheck }}">
        ...
        <div class="modal fade"  id="rejectedModal" tabindex="-1" role="dialog" aria-labelledby="rejectedModal" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('app.rejected.re') }}" method="POST">
                    @csrf
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
