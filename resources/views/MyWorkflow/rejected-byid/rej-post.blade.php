    ...
    <div class="row">
        ...
        <div class="col-md-12" style="margin: -20px 0 20px 0 " >
            <div class="form-group" style="margin: 0 -5px 0 -5px;">
                    <div class="col-md-1 float-left"><a href="/rejected" ><button type="button" style="width: 100%;" class="btn btn-dark" >Back</button></a></div>  
                    ...
                    <div class="col-md-1 float-right"><button type="button" style="width: 100%;" class="btn btn-warning float-right" data-toggle="modal" data-target="#replyModal" disabled >Reply</button></div>     
                    ...
                    <div class="col-md-1 float-right"><button type="button" style="width: 100%;" class="btn btn-secondary float-right " data-toggle="modal" data-target="#withdrawModal"  disabled>Withdraw</button></div>        
