...
<form id="formfield " method="POST" action="{{ route('post.saveDLV') }}"  class="form-horizontal"  enctype="multipart/form-data" > 
@csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">                                            
                                                            ...
                                                            <textarea style="resize:none" class="form-control" id="accountingRemarks" name="accountingRemarks" rows="3" placeholder=""></textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="paymentTerms" value="" id="paymentTerms">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="projectStart" data-target-input="nearest">
                                                                <input type="text" id="projectStartTextForm" name="projectStart" class="form-control datetimepicker-input" data-target="#projectStart"/>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="projectEnd" data-target-input="nearest">
                                                                <input type="text"  id="projectEndTextForm" class="form-control datetimepicker-input" name="projectEnd" data-target="#projectEnd"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2 select2-default" name="currency" data-dropdown-css-class="select2-default"  style="width: 100%;">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input data-type="currency" min="0" style="text-align: right" type="text" id="projectCost" class="form-control" name="projectCost"  placeholder="0.00" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');">
                                                        ...
                                                        <table class="table table-hover text-nowrap" id="systemsTable">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($systemName as $system )
                                                                    <tr>
                                                                        <td><input type="checkbox" class="systemNameForm" name="systemname[]"  value="{{ $system->id }}" > </td>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2 select2-default" name="downpaymentrequired" id="downPaymentRequiredForm" onchange="dprSet(this)" data-dropdown-css-class="select2-default" style="width: 100%;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2 select2-default" name="invoicerequired" id="invoiceRequiredForm" onchange="irSet(this)" data-dropdown-css-class="select2-default" style="width: 100%;">
                                                                <option value="1">Yes</option>
                                                                <option selected="selected" value="0">No</option>
                                                            </select>
                                                        </div>   
...
// }
    ...
    function generate(){
        ...
        var projectName = gclientCode+'-'+prjValue+'-DLV-'+gpoNumber+'-'+gprjShortText;
